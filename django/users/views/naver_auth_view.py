...
def handle_naver_callback(request):
    ...
    try:
        ...
        user, _ = User.objects.get_or_create(
            ...
            defaults={"nickname": user_info["response"]["nickname"]}
        )
        ...
        return JsonResponse({"error": "An error occurred during Naver authentication"}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
