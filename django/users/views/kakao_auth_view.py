...
def handle_kakao_callback(request):
    ...
    try:
        ...
        user, _ = User.objects.get_or_create(
            ...
            defaults={"nickname": user_info["properties"]["nickname"]}
        )
        ...
        return JsonResponse({"error": "An error occurred during Kakao authentication"}, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
